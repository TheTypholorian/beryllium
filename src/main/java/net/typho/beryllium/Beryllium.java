...
public class Beryllium implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        ResourceManagerHelper.registerBuiltinResourcePack(CONSTRUCTOR.id("bare_beryllium"), FabricLoader.getInstance().getModContainer(MOD_ID).get(), Text.translatable("pack.name.beryllium.bare_beryllium"), ResourcePackActivationType.NORMAL);
    }
}
