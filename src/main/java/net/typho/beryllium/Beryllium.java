...
public class Beryllium implements ModInitializer {
    ...
    public static boolean canFitEnchantment(ItemStack stack, Enchantment enchant) {
        ...
        return Beryllium.getUsedEnchCapacity(stack) + Beryllium.getEnchantmentCapacity(enchant) <= Beryllium.getMaxEnchCapacity(stack);
    }
    ...
    public static boolean hasEnoughCatalysts(ItemStack source, RegistryEntry<Enchantment> enchant, int level, PlayerEntity player) {
        ...
        ItemStack req = Beryllium.getEnchantmentCatalyst(enchant, level);
