...
public class Exploring implements ModInitializer, ClientModInitializer, EntityComponentInitializer, TerraBlenderApi {
    ...
    public static final RegistryEntry<EntityAttribute> PLAYER_AIR_MINING_EFFICIENCY = CONSTRUCTOR.attribute("player.air_mining_efficiency", new ClampedEntityAttribute("attribute.beryllium.name.player.stable_footing", 0.2, 0.001, 1).setTracked(true));
