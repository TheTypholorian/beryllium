...
public class Food implements ModInitializer {
    ...
    public static final Item BAGUETTE = CONSTRUCTOR.item("baguette", new BaguetteItem(new Item.Settings().food(CONSTRUCTOR.timedFood(2.5f).nutrition(9).saturationModifier(0.3F).build())));
