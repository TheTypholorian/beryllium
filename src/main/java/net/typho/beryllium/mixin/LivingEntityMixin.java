...
public abstract class LivingEntityMixin {
    ...
    private float getHDrag(float constant) {
        ...
        return (float) living.getAttributeValue(Beryllium.GENERIC_HORIZONTAL_DRAG);
    }
    ...
    private static void createLivingAttributes(CallbackInfoReturnable<DefaultAttributeContainer.Builder> cir) {
        cir.setReturnValue(cir.getReturnValue().add(Beryllium.GENERIC_HORIZONTAL_DRAG));
    }
    ...
    private void getVDrag(LivingEntity self, double x, double y, double z) {
        double drag = self.getAttributeValue(Beryllium.GENERIC_VERTICAL_DRAG);
